...
define('SECRET_SALT','HD_1zuuN70KWO4uCRUAe8mLm6LhNkUVC');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','canuardaniel@gmail.com');

# Database Options
# ---------------------------------------------------
# Mysql Login info
define('DBTYPE','mysql');
define('DBHOST','sql122.main-hosting.eu');
define('DBNAME','u596768707_cide');
define('DBUSER','u596768707_cide');
define('DBPASS','ju4ns0l0');
